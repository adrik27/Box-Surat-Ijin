    ...
    <form action="/Dashboard/Surat/{{ $surat->id }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="email" name="email" class="form-control @error('email')
                                                        is-invalid
                                                    @enderror" value="{{ old('email', $surat->email) }}" required
        ...
        <div class="mb-3">
            ...
            <select class="form-select" aria-label="Default select example" name="KategoriSurat_id" autocomplete="off">
                ...
                @if (old('KategoriSurat_id',$surat->KategoriSurat_id) == $ks->id)
        ...
        <div class="mb-3">
            ...
            <input type="date" name="TanggalMulaiIjin" class="form-control @error('TanggalMulaiIjin')
                                                                is-invalid
                                                            @enderror"
                value="{{ old('TanggalMulaiIjin',$surat->TanggalMulaiIjin) }}" required autocomplete="off" autofocus
                placeholder="Masukkan Tanggal Mulai Ijin">
        ...
        <div class="mb-3">
            ...
            <input type="date" name="TanggalSelesaiIjin" class="form-control @error('TanggalSelesaiIjin')
                                                                is-invalid
                                                            @enderror"
                value="{{ old('TanggalSelesaiIjin',$surat->TanggalSelesaiIjin) }}" required autocomplete="off" autofocus
                placeholder="Masukkan Tanggal Selesai Ijin">
        ...
        <div class="mb-3">
            ...
            <textarea type="text" name="catatan" class="form-control @error('catatan')
                                                                is-invalid
                                                            @enderror" value="{{ old('catatan',$surat->catatan) }}"
                required autocomplete="off" autofocus placeholder="Masukkan Catatan/Alasan Ijin"></textarea>
            @error('catatan')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="file" name="gambar" class="form-control @error('gambar')
                                                        is-invalid
                                                    @enderror" value="{{ old('gambar',$surat->gambar) }}"
                autocomplete="off" autofocus placeholder="Masukkan Gambar">
            @error('gambar')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
