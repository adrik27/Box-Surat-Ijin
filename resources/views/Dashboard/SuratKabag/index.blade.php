            ...
            <div class="card-body p-0">
                <div class="table-responsive active-projects">
                    <div class="tbl-caption">
                        <h4 class="heading mb-0">Surat Kabag</h4>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        @else
                                        <span class="badge badge-sm badge-danger">HRD tidak ada akses</span>
                                        @endif
                                    </td>
                                    <td>{{ $sp->catatan }}</td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="aksi d-flex gap-2 justify-content-center">
                                            <div class="acc">
                                                <form action="/Dashboard/Kabag/{{ $sp->id }}" method="POST"
                                            ...
                                            <div class="tolak">
                                                <form action="/Dashboard/Kabag/{{ $sp->id }}/Tolak" method="POST"
                                                    enctype="multipart/form-data">
                                                    @csrf
