...
<div class="row ">
    <div class="col-md d-flex justify-content-center">
        <h1>Update Kategori Surat </h1>
    </div>
</div>

<div class="row">
    <form action="/Dashboard/KategoriSurat/{{ $kb->id }}" method="post" enctype="multipart/form-data">
        @method('PUT')
        @csrf
        ...
        <div class="mb-3">
            ...
            <input type="text" name="nama" class="form-control @error('nama')
                                                        is-invalid
                                                    @enderror" value="{{ old('nama', $kb->nama) }}" autocomplete="off"
