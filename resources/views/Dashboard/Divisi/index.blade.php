...
<div class="row">
    <div class="col-md">
        <a href="/Dashboard/Divisi/create" class="btn btn-sm btn-success">Tambah Divisi</a>
    </div>
</div>
            ...
            <div class="card-body p-0">
                <div class="table-responsive active-projects">
                    <div class="tbl-caption">
                        <h4 class="heading mb-0">Divisi</h4>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="aksi d-flex gap-2 justify-content-center">
                                            <div class="edit">
                                                <a href="/Dashboard/Divisi/{{ $div->id }}/edit"
                                                    class="btn btn-sm btn-warning">Edit</a>
                                            </div>
                                            <div class="hapus">
                                                <form action="/Dashboard/Divisi/{{ $div->id }}" method="POST"
